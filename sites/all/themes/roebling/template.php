 ...
 */
function roebling_icon_links(&$links) {
  if (!empty($links)) {
 ...
 */
function roebling_preprocess_page(&$vars) {
  ...
  if (arg(0) === 'admin') {
    ...
    roebling_icon_links($vars['primary_links']);
  }
 ...
 */
function roebling_preprocess_block(&$vars) {
 ...
 */
function roebling_preprocess_context_block_editable_region(&$vars) {
 ...
 */
function roebling_preprocess_help(&$vars) {
  $vars['layout'] = FALSE;
  $vars['links'] = '';
}
 ...
 */
function roebling_preprocess_node(&$vars) {
 ...
 */
function roebling_preprocess_comment(&$vars) {
  // Add a time decay class.
  $decay = _roebling_get_comment_decay($vars['node']->nid, $vars['comment']->timestamp);
 ...
 */
function roebling_preprocess_node_form(&$vars) {
 ...
 */
function roebling_designkit_image($name, $filepath) {
  if ($name === 'logo') {
 ...
 */
function roebling_more_link($url, $title) {
 ...
 */
function roebling_breadcrumb($breadcrumb) {
 ...
 */
function roebling_preprocess_user_picture(&$vars) {
 ...
 */
function roebling_pager($tags = array(), $limit = 10, $element = 0, $parameters = array(), $quantity = 9) {
 ...
 */
function roebling_views_mini_pager($tags = array(), $limit = 10, $element = 0, $parameters = array(), $quantity = 9) {
  $tags[1] = t('Prev');
  $tags[3] = t('Next');
 ...
 */
function roebling_node_preview($node = NULL, $show = FALSE) {
  static $output;
 ...
 */
function roebling_content_multiple_values($element) {
 ...
 */
function roebling_preprocess_views_view_fields(&$vars) {
  foreach ($vars['fields'] as $field) {
    if ($class = _roebling_get_views_field_class($field->handler)) {
      $field->class = $class;
    }
  }
 ...
 */
function roebling_preprocess_views_view_table(&$vars) {
  $view = $vars['view'];
  foreach ($view->field as $field => $handler) {
    if (isset($vars['fields'][$field]) && $class = _roebling_get_views_field_class($handler)) {
 ...
 */
function _roebling_get_views_field_class($handler) {
 ...
 */
function _roebling_get_comment_decay($nid, $timestamp) {
  static $timerange;
